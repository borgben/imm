...
Proof using WNAF WF WATF2 WATF1 RWMODE RATF2 RATF1 NA AT.
...
Proof using All.
  ...
  { do 2 rewrite <- ct_unit. rewrite seqA. now rewrite <- ct_step. }
...
Proof using All. unfold psc. rewrite sb_in_hb. basic_solver 10. Qed. 

Lemma RFE1: rfe^+ ≡ rfe.
Proof using All.  apply ct_no_step. rewrite (wf_rfeD WF). type_solver. Qed. 
...
Proof using All.
  rewrite rfi_union_rfe, restr_union, <- unionA.
...
Proof using All. intros A r. basic_solver. Qed. 
